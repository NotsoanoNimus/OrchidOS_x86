...
;szIntro1 db "                      _     _     _      ____     _____  ", 0
;szIntro2 db "                     | |   (_)   | |    /    \   /  ___/ ", 0
;szIntro3 db "        ___  _ __ ___| |__  _  __| |   /  /\  \ |  /__   ", 0
;szIntro4 db "       / _ \| '__/ __| '_ \| |/ _` |  |  |  |  | \___ \  ", 0
;szIntro5 db "      | (_) | | | (__| | | | | (_| |   \  \/  /  ___/  | ", 0
;szIntro6 db "       \___/|_|  \___|_| |_|_|\__,_|    \____/  /_____/  ", 0
...
_introOverlay:
	...
	; Useless loop to consume some time...
;	mov ecx, 0x03FFFFFF
; .timerWait:
;	loop _introOverlay.timerWait
